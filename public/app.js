...
const translations = {
  ...
  criteriaTooltips: {
    ...
    exposureTime: {
      formula: 'Середній час продажу схожих об\'єктів у районі\n(тип + кімнати + площа ±30%)\n\nЧим швидше продаються аналоги — тим вищий бал\nДіапазон: 0–10',
      example: 'Сегмент: Голосіївський, 2к, 45-75 м²\nМедіана 42 дні (мін 12, макс 95)\nS = 10 × (95 - 42) / (95 - 12) = 6.4',
    },
    competition: {
