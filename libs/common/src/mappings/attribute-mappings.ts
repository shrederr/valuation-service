...
/** RealtorUA border → project type.
 *  Only values that represent actual house TYPES (not building materials).
 *  Materials (Цегляна, Блочна, Панельна, Газоблок) go to housing_material only. */
export const REALTOR_UA_BORDER_MAP: Record<string, string> = {
  ...
  // NOTE: Цегляна, Блочна, Панельна, Газоблок, Українська цегла
  // are building MATERIALS, not project types → handled in housing_material only
};
