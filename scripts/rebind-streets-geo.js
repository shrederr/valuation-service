...
async function main() {
  ...
  console.log('=== Перепривязка улиц к самому нижнему geo ===\n');

  // Сначала проверим сколько улиц нужно обновить
  ...
  // Проверим результат для тестовой улицы
  console.log('\n=== Проверка ===');
  ...
  console.log(`Улица: ${r.street}`);
  console.log(`Новый geo_id: ${r.geo_id} (${r.geo_name}, ${r.type})`);
